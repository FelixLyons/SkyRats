package com.skyrats.GUIs;

import com.skyrats.Backend.GUIs.Features;
import com.skyrats.Backend.GUIs.FeaturesToggle;
import com.skyrats.Backend.SavingManager;
...
public class HomeGUI extends Screen {
    ...
    private void drawHomePanelContent(DrawContext context, int x, int offsetY, int mouseX, int mouseY) {
        ...
        context.drawTextWithShadow(textRenderer,"SkyRats v" + SkyRats.MOD_VERSION, x, offsetY, 0xFF3F76E4);
        offsetY += 18;
